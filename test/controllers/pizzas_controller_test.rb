...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { cost: @pizza.cost, ingredients: @pizza.ingredients, name: @pizza.name, time_to_cook: @pizza.time_to_cook }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { cost: @pizza.cost, ingredients: @pizza.ingredients, name: @pizza.name, time_to_cook: @pizza.time_to_cook }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
